...
public class TrangChuDocGia extends javax.swing.JFrame {
        ...
        public void loadChiTietPhieuMuon() {
                ...
                for (PhieuMuon ctpns : chiTietPhieuNhapSaches) {
                        System.out.println(ctpns);
                        defaultTableModel_CTPM
                                        .addRow(new Object[] { ctpns.getMaPhieuMuon(), ctpns.getNgayMuon(),
                                                        ctpns.getHanTraSach(),
                                                        ctpns.getSoLuongSach(), ctpns.getTrangThai() });
                }
        }
        ...
        private void setTableData_Sach(List<Sach> listSach) {
                for (Sach sach : listSach) {
                        ...
                        defaultTableModel_Sach
                                        .addRow(new Object[] { sach.getMaSach(), sach.getTenSach(),
        ...
        private void initComponents() {
                ...
                // "Tìm theo danh mục", "Chuyên ngành Điện-Điện tử", "Chuyên ngành Cơ khí",
                // "Chuyên ngành Công nghệ thông tin", "Chuyên ngành Xây dựng", "Sách Tiếng
                // Anh", "Kỹ năng sống" }));
                ...
                jTabbedPane1.addTab("LỊCH SỬ                    ",
                                new javax.swing.ImageIcon(getClass().getResource("/Images/contact-list.png")), jPanel5); // NOI18N
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(TrangChuDocGia.class.getName()).log(
