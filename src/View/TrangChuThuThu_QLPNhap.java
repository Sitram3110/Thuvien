...
public class TrangChuThuThu_QLPNhap extends javax.swing.JFrame {
    ...
    public void loadmaPhieuNhap() {
        ...
        for (PhieuNhapSach pns : phieuNhapSach) {
            defaultTableModel_PN
                    .addRow(new Object[] { pns.getMaPhieuNhap(), pns.getNgayNhap(), pns.getMaNhaCungCap() });
        }
    }
        ...
        if (DelBtn.isEnabled()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,
                        "Năm xuất bản, số lượng nhập, giá nhập: Vui lòng điền đúng định dạng số.");
            }
            if (comboBoxMaPNhap.getSelectedItem().equals("") || maSachField.getText().equals("")
                    || maTGiaFiedl.getText().equals("") || soLuongField.getText().equals("") ||
                    tenSachField.getText().equals("") || tenTGiaField.getText().equals("")
                    || GNhapField.getText().equals("") || nxbField.getText().equals("")
                    || namXBField.getText().equals("")) {
